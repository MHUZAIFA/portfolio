    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-justify">
            Each recognition represents not just individual achievement, but the
            collaborative effort of teams working together to solve complex
                ...
                {honor.fullDescription && (
                  ...
                  >
                    {expandedId === honor.id ? (
                      ...
                      {/* Description */}
                      <p className="mb-4 text-white/80">{honor.description}</p>
